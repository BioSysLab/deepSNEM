...
group_check(group = htr,group_name = group_name,original_big_group = obg,
            labels = labels, emb_test = emb,file_info = file_info,emb_size = 512,
            output_dir = output_dir, label_space_only = F, tsne_perpl = 25, init_dim = 50,umap_n = 50, cell_specific = F,cell_line = "A375",
            genes = T,
