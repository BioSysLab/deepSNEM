...
def rdkit2graph(smiles):
    atoms, bonds, edges = tensorise_smiles(smiles)
    edge_index = dense_to_sparse(edges)
    data = Data(x=atoms, edge_attr=bonds, edge_index=edge_index)
    return data